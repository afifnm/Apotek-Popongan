...
uses
  ...
  Dialogs, StdCtrls, Grids, DBGrids, ComCtrls, jpeg, ExtCtrls;
...
dm.ADOQuery1.Open;
  // File Struk.txt
        ...
        begin
          ...
          WriteLn(txtFile, RataKanan(floattostr(dm.ADOQuery1['jumlah'])+' PCS        Rp.'+formatcurr('#,###',dm.ADOQuery1['harga_jual']), 'Rp. '+formatcurr('#,###',subtotal), 35, ' '));
        dm.ADOQuery1.Next;
        end;
        WriteLn(txtFile, '==========================================');
        WriteLn(txtFile, RataKanan('Total        : ', 'Rp. '+formatcurr('#,###',total), 35,' '));
        WriteLn(txtFile, RataKanan('Bayar        : ', 'Rp. '+formatcurr('#,###',strtofloat(edit3.Text)), 35,' '));
        WriteLn(txtFile, RataKanan('Kembali      : ', 'Rp. '+formatcurr('#,###',strtofloat(edit3.Text)-total), 35,' '));
        WriteLn(txtFile, '==========================================');
